...
const DiscoverSection = () => {
  return (
    ...
    >
      <div className="max-w-6xl lg:max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 xl:px-16">
          ...
          {[
            {
              ...
              description:
                "Browse through our extensive collection of our rental properties in your desired location.",
            },
            {
              imageSrc: "/landing-icon-calendar.png",
              title: "Book Your Rental",
              description:
                "Once you found your perfect rental property, easily book it online with just a few clicks.",
            },
            {
